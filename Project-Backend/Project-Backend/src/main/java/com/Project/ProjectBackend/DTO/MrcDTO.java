...
public class MrcDTO {
    ...
    public MrcDTO(int mrcid, String mrcnumber, String mrcdrivername, String mrctime , String mrcdate, String mrcplace, String mrcloadone, String mrcloadtwo, String mrcstatus) {
        this.mrcid = mrcid;
